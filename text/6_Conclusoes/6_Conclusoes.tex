...
Em terceiro lugar, retornos diários de ativo líquido apresentam expectativa empírica de \(R^2\) fora da amostra reduzida (tipicamente entre \(0{,}1\%\) e \(1\%\) na literatura de \textit{equity premium}), o que torna empiricamente plausível a ausência de superioridade do candidato TFT \textit{all-features} frente a baselines simples. Refutação de H2a ou H2b é, nesse contexto, resultado científico válido sobre os limites do estimador para os ativos avaliados sob protocolo OOS auditável, e não falha do método.
