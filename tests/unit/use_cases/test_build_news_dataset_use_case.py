# tests/unit/use_cases/test_build_news_dataset_use_case.py
...
def test_build_news_dataset_dedups_overlap_by_url_and_advances_cursor_correctly():
    """
...
def test_build_news_dataset_resumes_from_latest_persisted_and_seeds_seen_urls():
    """
...
def test_build_news_dataset_empty_batch_advances_cursor_by_configured_delta():
    """
...
def test_build_news_dataset_stalling_protection_forces_step_forward_when_no_progress():
    """
...
def test_build_news_dataset_rejects_naive_start_or_end():
    asset = "AAPL"
    use_case = BuildNewsDatasetUseCase(
