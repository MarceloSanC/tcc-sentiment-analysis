# tests/unit/use_cases/test_score_news_dataset_use_case.py
...
class FakeScoredNewsRepository(ScoredNewsRepository):
    ...
    def list_scored_news(self, asset_id: str, start_date: datetime, end_date: datetime):
        return []
...
def _article(asset_id: str, article_id: str | None, published_at: datetime) -> NewsArticle:
    return NewsArticle(
        asset_id=asset_id,
